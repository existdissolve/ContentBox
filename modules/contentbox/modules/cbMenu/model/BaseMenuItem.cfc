component persistent="true" entityName="cbMenuItem" table="cb_menuItem" cachename="cbMenuItem" cacheuse="read-write" discriminatorColumn="menuType" {
    // DI Injections
    property name="menuItemService" inject="menuItemService@cbMenu" persistent="false";
    ...
    // M20 - Owning menu
    property name="menu" cfc="Menu" fieldtype="many-to-one" fkcolumn="FK_menuID" lazy="true" fetch="join" notnull="true";
    // M20 - Parent Menu item
    property name="parent"  cfc="BaseMenuItem" fieldtype="many-to-one" fkcolumn="FK_parentID" lazy="true";
    // O2M - Child Menu Item
    property name="children" singularName="child" fieldtype="one-to-many" type="array" lazy="extra" batchsize="25"
             cfc="BaseMenuItem" fkcolumn="FK_parentID" inverse="true" cascade="all-delete-orphan";
